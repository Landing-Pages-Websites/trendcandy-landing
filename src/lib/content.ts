...
// Director directive 2026-05-15: full rebuild to match brand on https://www.trendcandy.io/.
...
// → form is step one (gateway); every fill posts to Keystone, and on a
//   successful submission the visitor is redirected to Calendly to pick a time.
